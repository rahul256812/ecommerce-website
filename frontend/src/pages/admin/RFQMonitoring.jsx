        ...
        <Sidebar>
            <div>
                <div className="page-header">
                    ...
                    <h1>RFQ Monitoring</h1>
                    <p>Track all quotation requests across the platform.</p>
                </div>
                                ...
                                <tbody>
                                    {filtered.map((r, i) => (
                                        <tr key={r.id} className="animate-fadeIn" style={{ animationDelay: `${i * 20}ms` }}>
                                            ...
                                            <td className="text-sm text-gray-500">{new Date(r.created_at).toLocaleDateString()}</td>
